...
use nomad_amm::accounts as nomad_amm_accounts;
use nomad_amm::instruction as nomad_amm_instructions;
use nomad_amm::{
...
pub fn initialize_pool_instr(
    ...
    let mut instructions = program
        .request()
        .accounts(nomad_amm_accounts::Initialize {
        ...
        .args(nomad_amm_instructions::Initialize {
            init_amount_0,
            init_amount_1,
            open_time,
            pyth_price_feed_id,
...
pub fn deposit_instr(
    ...
    let instructions = program
        .request()
        .accounts(nomad_amm_accounts::Deposit {
            owner: program.payer(),
            authority,
            pool_state: pool_id,
        ...
        .args(nomad_amm_instructions::Deposit {
            lp_token_amount,
...
pub fn withdraw_instr(
    ...
    let instructions = program
        .request()
        .accounts(nomad_amm_accounts::Withdraw {
            owner: program.payer(),
            authority,
            pool_state: pool_id,
            owner_lp_token: user_token_lp_account,
        ...
        .args(nomad_amm_instructions::Withdraw {
            lp_token_amount,
...
pub fn swap_base_input_instr(
    ...
    let instructions = program
        .request()
        .accounts(nomad_amm_accounts::Swap {
            payer: program.payer(),
            authority,
            amm_config,
            pool_state: pool_id,
        ...
        .args(nomad_amm_instructions::SwapBaseInput {
            amount_in,
            minimum_amount_out,
        })
        .instructions()?;
...
pub fn swap_base_output_instr(
    ...
    let instructions = program
        ...
        .args(nomad_amm_instructions::SwapBaseOutput {
            max_amount_in,
            amount_out,
        })
        .instructions()?;
