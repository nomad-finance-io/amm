...
impl CurveCalculator {
    ...
    ///
    /// `spot_num / spot_den` is the oracle spot rate oriented as
    /// *output-per-input* for the current trade direction (caller inverts the
    /// raw `token_1 / token_0` fraction when the input side is token_1).
    pub fn swap_base_input(
        ...
        let output_amount_swapped = OracleCurve::swap_base_input_without_fees(
    ...
    pub fn swap_base_output(
        ...
        let input_amount_swapped = OracleCurve::swap_base_output_without_fees(
