...
| `SOLANA_RPC_URL`   | yes | Secrets Manager (name: `SOLANA_RPC_URL_SECRET_NAME`, default `nomad/SOLANA_RPC_URL`)     |
...
```bash
aws secretsmanager create-secret --name nomad/SOLANA_RPC_URL    --secret-string '...'
